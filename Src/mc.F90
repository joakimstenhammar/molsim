...
! ..............   linear .............
   ...
   if(ict==3) then
    ...
    do iseg_loc = max(1,iseg_min-1), iseg_min +1, 2  !  compare distance form the two neighbours of the closest particle ipnsegcn(iseg_min,ic_temp) to particle ip3
    ...
    do iseg_loc = max(1,iseg_min-1), iseg_min +1, 2
